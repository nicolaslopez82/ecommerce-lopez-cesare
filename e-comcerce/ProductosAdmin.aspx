...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card" width="100%" style="border-radius:20px; width: 18rem;border: solid 1px black; padding: 10px; margin: 15px;  ">
        ...
        <div class="card-body">
            ...
            <hr />
            <a href="EliminarProducto.aspx?id=<%: pro.ID %>" style="border-radius:20px;" class="btn btn-danger">Eliminar</a>
            <hr />
            <a href="ModificarProducto.aspx?id=<%: pro.ID %>" style="border-radius:20px;" class="btn btn-success">Modificar</a>
